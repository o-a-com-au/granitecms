...
- `"type": "string", "format": "color"` - an `<input type="color">`, value as a hex string (e.g. `"#ff6600"`); an absent/empty value defaults to `#000000` in the widget (native colour inputs cannot be blank).
